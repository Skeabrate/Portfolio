...
const Footer = () => {
  return (
    <footer className="flex flex-col items-center gap-4 px-4 pb-8 pt-16 text-center">
      ...
      <ul className="flex gap-4 after:absolute after:bottom-0 after:left-1/2 after:hidden after:h-20 after:w-[1px] after:-translate-x-1/2 after:bg-slate-800 dark:after:bg-slate-200 lg:fixed lg:bottom-0 lg:left-0 lg:h-[340px] lg:w-24 lg:flex-col lg:items-center lg:gap-7 lg:pt-14 lg:after:block">
        <li>
